...
{
    public class GetCheckoutMarketItemPricesListQueryHandlerTest5
    {
        ...
        public GetCheckoutMarketItemPricesListQueryHandlerTest5()
        {
            _mockMarketItemOfferRepo = MockMarketItemOfferRepository.GetMarketItemOffers();
            _mockMarketitemQuantityRepo = MockMarketItemQuantityRepository.GetMarketItemQuantityDetailsTest5();
        ...
        public async Task GetCheckoutMarketItemPricesListTest()
        {
            ...
            result.Sum(x => x.Price).ShouldBe(16.61);
